...
function ComparePanel({ sims, onClose }: { sims: [Simulation, Simulation]; onClose: () => void }) {
  ...
  return (
    <div className="rounded-xl overflow-hidden mb-2" style={{ border: '1px solid rgba(241,192,134,0.25)', background: 'rgba(241,192,134,0.04)' }}>
      <div className="flex items-center justify-between px-5 py-3" style={{ borderBottom: '1px solid rgba(241,192,134,0.15)' }}>
...
function SimCard({ sim, onDelete, selected, onSelect, selectMode }: { sim: Simulation; onDelete: () => void; selected: boolean; onSelect: () => void; selectMode: boolean }) {
  ...
  return (
    <Card className="group" style={selected ? { borderColor: 'rgba(241,192,134,0.5)', background: 'rgba(241,192,134,0.03)' } : {}}>
