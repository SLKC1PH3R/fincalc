...
async function main() {
  ...
  const sims = [
    ...
    // ── Flat Tax vs Barème ────────────────────────────────────────────────────
    {
      ...
      results: {
        ...
        recommended: 'flat_tax', saving: 477, breakevenTMI: 30, chartData: [],
      },
    },
    {
      type: 'flat-tax',
      ...
      results: {
        ...
        recommended: 'bareme', saving: 216, breakevenTMI: 30, chartData: [],
      },
    },
  ...
  const envelopes = [
    ...
    {
      type: 'CRYPTO', name: 'Crypto (Ledger)', sortOrder: 7,
      metadata: { currentValue: 4200, assets: 'BTC, ETH' },
    },
    {
      type: 'CASH', name: 'Compte courant', sortOrder: 8,
