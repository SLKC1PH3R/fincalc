      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 6 }}>
            <span style={{ width: 10, height: 10, borderRadius: 99, background: '#E5A499' }} />
            <span style={{ width: 10, height: 10, borderRadius: 99, background: '#E5C488' }} />
            <span style={{ width: 10, height: 10, borderRadius: 99, background: '#A8C9A0' }} />
          </div>
          <div style={{
            flex: 1, textAlign: 'center',
            fontFamily: 'var(--f-mono)', fontSize: 11, color: 'var(--muted)',
          }}>patrimo.finance/dashboard</div>
          <div style={{ width: 40 }} />
        </div>
