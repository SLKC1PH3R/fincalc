      ...
      <div style={{ display: 'grid', gridTemplateColumns: '270px 1fr 290px', gap: 16, alignItems: 'start' }}>
        ...
        <div style={{ position: 'sticky', top: 20, display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              <div style={{ background: `${COLOR}08`, border: `1px solid ${COLOR}20`, borderRadius: 10, padding: '10px 12px' }}>
                ...
                {[{ label: 'Inflation France 2024', val: '2,3%' }, { label: 'Cible BCE', val: '2,0%' }, { label: 'Inflation 2022 (pic)', val: '5,2%' }].map(ref => (
                  <div key={ref.label} style={{ display: 'flex', justifyContent: 'space-between', padding: '4px 0', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                    <span style={{ fontSize: 11, color: 'var(--text-muted-c)' }}>{ref.label}</span>
          ...
          <div style={{ background: `${COLOR}0d`, border: `1px solid ${COLOR}25`, borderRadius: 12, padding: '12px 14px', display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            {[
              ...
              { label: 'Valeur réelle', value: fmt(r.realFinal), color: 'var(--text-primary)' },
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div style={{ background: 'var(--card-dark)', border: '1px solid var(--card-dark-border)', borderRadius: 12, padding: '14px 16px' }}>
            <p style={{ fontSize: 11, fontWeight: 700, color: 'var(--text-primary)', marginBottom: 12 }}>Que vaut 1 000 € dans X ans ?</p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                ...
                return (
                  <div key={yr}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
                      <span style={{ fontSize: 11, color: 'var(--text-muted-c)' }}>Dans {yr} ans</span>
              ...
              <p style={{ fontSize: 10, color: 'var(--text-subtle)', marginTop: 4 }}>Pouvoir d&apos;achat de 1 000 € d&apos;aujourd&apos;hui à {inputs.inflationRate}% d&apos;inflation/an.</p>
            </div>
          </div>

          {/* Solutions anti-inflation */}
          <div style={{ background: 'var(--card-dark)', border: '1px solid var(--card-dark-border)', borderRadius: 12, padding: '14px 16px' }}>
            <p style={{ fontSize: 11, fontWeight: 700, color: 'var(--text-primary)', marginBottom: 10 }}>Solutions anti-inflation</p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {[
