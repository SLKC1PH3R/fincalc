...
const COPY = {
  fr: {
    ...
    iv_labs: [
      { n:'01', badge:'Défiscalisé',    title:"Livrets d'épargne",  body:"Livret A · LDDS · LEP. Épargne réglementée disponible à tout moment.", img:'/livrets.jpg',      cat:'epargne',   href:'/dashboard/patrimoine/livrets' },
      { n:'02', badge:'Exonéré 5a+',   title:'PEA',                body:"L'enveloppe reine de l'investissement en actions européennes.",         img:'/PEA.jpg',           cat:'actions',   href:'/dashboard/patrimoine/actions' },
      { n:'03', badge:'Abattement 8a', title:'Assurance-Vie',      body:"Fonds € · UC. Succession optimisée, fiscalité adoucie après 8 ans.",   img:'/AV.jpg',            cat:'epargne',   href:'/dashboard/patrimoine/actions' },
      { n:'04', badge:'Flat Tax 30 %', title:'CTO',                body:"Toutes classes d'actifs, aucun plafond. Liberté absolue.",             img:'/CTO.jpg',           cat:'actions',   href:'/dashboard/patrimoine/actions' },
      { n:'05', badge:'Déduction IR',  title:'PER',                body:"Déduisez aujourd'hui dans votre TMI, capitalisez demain.",             img:'/PER.jpg',           cat:'epargne',   href:'/dashboard/patrimoine' },
      { n:'06', badge:'Levier bancaire',title:'Immobilier',        body:"SCPI · Direct · LMNP. Revenus locatifs récurrents.",                  img:'/immobilliers.jpg',  cat:'immobilier',href:'/dashboard/patrimoine/immobilier' },
      { n:'07', badge:'3916-bis',      title:'Crypto-actifs',      body:"BTC · ETH. Flat tax 30 % sur les cessions, déclaration annuelle.",    img:'/crypto.jpg',        cat:'actions',   href:'/dashboard/patrimoine/autres' },
      { n:'08', badge:'Précaution',    title:'Trésorerie',         body:"3 à 6 mois de dépenses. Réserve d'opportunité.",                      img:'/liquidites.jpg',    cat:'epargne',   href:'/dashboard/patrimoine/comptes' },
    ],
    iv_roadmap: [
      { n:'09', q:'Q2 2026', badge:'Vue globale',  title:"Vue d'ensemble",   body:"Bilan Patrimonial complet : actifs, passifs, répartition et évolution dans le temps.", href:'/dashboard/patrimoine' },
      { n:'10', q:'Q2 2026', badge:'Dettes',       title:'Emprunts',         body:"Capital restant dû, mensualités et date de fin de chaque crédit en cours.", href:'/dashboard/patrimoine/emprunts' },
      { n:'11', q:'Q2 2026', badge:'Tracker',      title:'Mon Portefeuille', body:"Positions en temps réel : prix, variation, poids et performance globale.", href:'/dashboard/portfolio' },
      { n:'12', q:'Q3 2026', badge:'Cible',        title:'Mes Objectifs',    body:"Définissez des objectifs d'épargne ou d'investissement et suivez votre progression.", href:'/dashboard/goals' },
      { n:'13', q:'Q3 2026', badge:'Allocation',   title:'Rééquilibrage',    body:"Calculez les achats et ventes nécessaires pour revenir à votre cible.", href:'/dashboard/rebalancing' },
      { n:'14', q:'Q3 2026', badge:'Déclaration',  title:'Rapport Fiscal',   body:"Synthèse annuelle : dividendes, coupons, plus-values réalisées.", href:'/dashboard/tax-report' },
      { n:'15', q:'Q4 2026', badge:'Score 0-100',  title:'Score Patrimonial',body:"Note globale basée sur diversification, liquidité et risque de votre Patrimoine.", href:'/dashboard/score' },
    ],
    ...
    ft_col1: 'Plateforme',
    ft_col1_links: [['/dashboard/patrimoine','Vision Patrimoniale'],['/tools/optimiseur-etf','Optimisation TER'],['/tools','18 simulateurs'],['/dashboard/score','Score Patrimonial']],
    ft_col2: 'Enveloppes',
    ft_col2_links: [['/dashboard/patrimoine/actions','PEA · AV · PER'],['/dashboard/patrimoine/livrets','CTO · Livrets'],['/dashboard/patrimoine/immobilier','SCPI · Immobilier'],['/dashboard/patrimoine/autres','Crypto · Cash']],
    ft_col3: 'Ressources',
  ...
  en: {
    ...
    iv_labs: [
      { n:'01', badge:'Tax-free',         title:'Savings accounts', body:'Livret A · LDDS · LEP. Regulated savings available at any time.',           img:'/livrets.jpg',      cat:'epargne',    href:'/dashboard/patrimoine/livrets' },
      { n:'02', badge:'Exempt 5y+',       title:'PEA',              body:'The prime wrapper for French and European equity investment.',               img:'/PEA.jpg',           cat:'actions',    href:'/dashboard/patrimoine/actions' },
      { n:'03', badge:'Allowance 8y',     title:'Life Insurance',   body:'Euro funds · Units. Optimised inheritance, softened tax after 8 years.',    img:'/AV.jpg',            cat:'epargne',    href:'/dashboard/patrimoine/actions' },
      { n:'04', badge:'Flat Tax 30%',     title:'CTO',              body:'All asset classes, no ceiling. Absolute freedom.',                          img:'/CTO.jpg',           cat:'actions',    href:'/dashboard/patrimoine/actions' },
      { n:'05', badge:'Tax deduction',    title:'PER',              body:'Deduct today at your marginal rate, capitalise tomorrow.',                  img:'/PER.jpg',           cat:'epargne',    href:'/dashboard/patrimoine' },
      { n:'06', badge:'Bank leverage',    title:'Real Estate',      body:'SCPI · Direct · LMNP. Recurring rental income.',                           img:'/immobilliers.jpg',  cat:'immobilier', href:'/dashboard/patrimoine/immobilier' },
      { n:'07', badge:'Annual report',    title:'Crypto assets',    body:'BTC · ETH. Flat tax 30% on disposals, annual reporting.',                  img:'/crypto.jpg',        cat:'actions',    href:'/dashboard/patrimoine/autres' },
      { n:'08', badge:'Safety net',       title:'Cash',             body:'3 to 6 months of expenses. Opportunity reserve.',                          img:'/liquidites.jpg',    cat:'epargne',    href:'/dashboard/patrimoine/comptes' },
    ],
    iv_roadmap: [
      { n:'09', q:'Q2 2026', badge:'Overview',    title:'Net Worth',      body:'Full wealth balance sheet: assets, liabilities, allocation and trend.', href:'/dashboard/patrimoine' },
      { n:'10', q:'Q2 2026', badge:'Liabilities', title:'Loans',          body:'Outstanding capital, monthly payments and end date for each loan.', href:'/dashboard/patrimoine/emprunts' },
      { n:'11', q:'Q2 2026', badge:'Tracker',     title:'My Portfolio',   body:'Real-time positions: price, change, weight and overall performance.', href:'/dashboard/portfolio' },
      { n:'12', q:'Q3 2026', badge:'Target',      title:'My Goals',       body:'Set savings or investment goals and track your progress step by step.', href:'/dashboard/goals' },
      { n:'13', q:'Q3 2026', badge:'Allocation',  title:'Rebalancing',    body:'Calculate the buys and sells needed to return to your target allocation.', href:'/dashboard/rebalancing' },
      { n:'14', q:'Q3 2026', badge:'Tax report',  title:'Fiscal Report',  body:'Annual summary: dividends, coupons and realised capital gains.', href:'/dashboard/tax-report' },
      { n:'15', q:'Q4 2026', badge:'Score 0-100', title:'Wealth Score',   body:'Global rating based on diversification, liquidity and risk of your wealth.', href:'/dashboard/score' },
    ],
    ...
    ft_col1: 'Platform',
    ft_col1_links: [['/dashboard/patrimoine','Wealth overview'],['/tools/optimiseur-etf','TER optimisation'],['/tools','18 simulators'],['/dashboard/score','Wealth score']],
    ft_col2: 'Wrappers',
    ft_col2_links: [['/dashboard/patrimoine/actions','PEA · Life ins. · PER'],['/dashboard/patrimoine/livrets','CTO · Savings'],['/dashboard/patrimoine/immobilier','SCPI · Real estate'],['/dashboard/patrimoine/autres','Crypto · Cash']],
    ft_col3: 'Resources',
        ...
        <section id="score" style={{ padding: '130px 0' }}>
          <div className="az-dark">
            ...
            <div className="az-dgrid">
              ...
              <a className="az-wcard rot1" href="/dashboard/score" data-az>
