    ...
    <div style={{ background: '#060606', color: '#fff', minHeight: '100vh', fontFamily: "'Geist', system-ui, sans-serif" }}>
      ...
      <main style={{ maxWidth: 800, margin: '0 auto', padding: '60px 20px 100px' }}>
        ...
        {[
          {
            title: '1. Objet',
            content: `Les présentes Conditions Générales d'Utilisation (CGU) régissent l'accès et l'utilisation du service FinCalc, accessible à l'adresse fire.digitalstack.cloud. En accédant au service, vous acceptez sans réserve les présentes CGU.`,
          },
          {
